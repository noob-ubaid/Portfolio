...
const Project = ({ project }) => {
  ...
  return (
    <>
      <motion.div
        className="flex flex-col p-6 md:p-8 gap-6 md:gap-8 lg:flex-row items-stretch bg-white/5 backdrop-blur-sm border border-main/30 rounded-2xl overflow-hidden hover:border-main/60 transition-all duration-500 group shadow-lg hover:shadow-main/20"
      ...
      >
        ...
        >
            ...
            <motion.div variants={itemVariants}>
              ...
              <div className="flex flex-wrap gap-3">
                {techStack.map((tech, i) => (
                  <motion.span
                    key={tech}
                    className="tech-bubble px-3 py-2 bg-black/10 backdrop-blur-sm rounded-full text-sm text-white/80 border border-white/20 hover:bg-cyan-400/20 hover:border-cyan-400 transition-colors cursor-pointer"
          ...
          {/* Action Buttons */}
          <motion.div
            className="flex gap-4 pt-6 mt-6 border-t border-main/20"
            variants={buttonVariants}
          >
            <motion.button
              onClick={() => setIsModalOpen(true)}
              className="flex items-center gap-3 px-8 py-4 bg-main text-black hover:text-white rounded-xl font-semibold hover:shadow-lg hover:shadow-main/30 transition-all duration-300 flex-1 justify-center group"
              variants={buttonVariants}
              whileHover="hover"
              whileTap="tap"
            >
            ...
            <motion.a
              ...
              className="flex items-center gap-3 px-8 py-4 bg-transparent text-main rounded-xl font-semibold border-2 border-main hover:bg-main hover:text-white transition-all duration-300 flex-1 justify-center group"
              variants={buttonVariants}
              whileHover="hover"
              whileTap="tap"
            >
          ...
          >
            ...
            >
              ...
              <div className="p-6 space-y-8">
                ...
                >
                  <h2 className="text-4xl font-bold text-main">{name}</h2>
                  {teamProject && (
                    <span className="px-6 py-3 bg-main/20 text-main rounded-full border border-main/30 text-lg font-semibold">
                      Team Project
                    </span>
                  )}
                </motion.div>
                ...
                >
                  ...
                  <div className="grid gap-4">
                    {features.map((feature, index) => (
                      <motion.div
                        key={index}
                        className="flex items-start gap-4 p-4 bg-main/5 rounded-xl border border-main/20 hover:border-main/40 transition-all duration-300"
                      ...
                      >
                        <div className="w-3 h-3 bg-main rounded-full mt-2 flex-shrink-0" />
