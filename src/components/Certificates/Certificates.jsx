...
const Certificates = () => {
  ...
  return (
    <Container>
      ...
      <p className="text-gray-300/70 max-w-4xl mx-auto text-center">
        I believe in continuous learning to sharpen and strengthen my web
        development skills, building a solid foundation for my career, and here
        is a certification I’ve proudly earned so far as part of my growth
        journey.
      </p>
      <div className="flex items-center flex-col mt-6 md:mt-10 lg:flex-row border border-main/40 p-4 md:p-8 rounded-md gap-8 md:gap-12">
        ...
        <div className="flex-1 flex flex-col gap-4">
          ...
          <p className="text-gray-300/70">
            Completed a frontend web development course at Hablu Programmer, gaining hands-on experience building responsive and user-friendly websites with HTML, CSS, and JavaScript. I strengthened my coding skills through real projects and learned essential developer tools, version control, and debugging techniques to confidently handle real-world frontend challenges.
          </p>
          <p className="text-gray-300/70">Awarded certificate in December 2024</p>
